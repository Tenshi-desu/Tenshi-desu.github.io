...
createCollectable("coin", 700, 200, 0, 0)
createCollectable("coin", 1300, 650, 1, 1)
createCollectable("coin", 350, 550, 1, 1)
createCollectable("coin", 1300, 100, 1, 1)
createCollectable("coin", 25, 150, 1, 1)
